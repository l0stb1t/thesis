...
C_PAIRS = ((C_LSHOULDER, C_LHIP, C_BLUE), (C_RSHOULDER, C_RHIP, C_GREEN), (C_LHIP, C_RHIP), (C_LKNEE, C_LHIP, C_BLUE), (C_RKNEE, C_RHIP, C_GREEN), (C_LANKLE, C_LKNEE, C_BLUE), (C_RANKLE, C_RKNEE, C_GREEN), (C_RWRIST, C_RELBOW, C_GREEN), (C_LWRIST, C_LELBOW, C_BLUE), (C_RELBOW, C_RSHOULDER, C_GREEN), (C_LELBOW, C_LSHOULDER, C_BLUE), (C_LSHOULDER, C_NECK, C_BLUE), (C_RSHOULDER, C_NECK, C_GREEN), (C_NOSE, C_LEAR, C_BLUE), (C_NOSE, C_REAR, C_GREEN))
